function lerDados(){
    ...
    xhttp.onreadystatechange = function(){
        if( this.readyState == 4 && this.status == 200){
            ...
            pessoa = dados.getElementByTagName("pessoa");

            nome = pessoa[0].getElementByTagName("nome");
            nomePessoa = nome[0].childNodes[0].nodeValue;

            idade = pessoa[0].getElementByTagName("idade");
        ...
        if( this.readyState == 4 && this.status == 200){
            ...
            // }else{
                ...
                for (i=0; i < produtos.length; i++){
                    ...
                    tabela += "     <td><button onclick='excluir("+id+")'>Excluir</button></td>";
                    tabela += " </tr>";
